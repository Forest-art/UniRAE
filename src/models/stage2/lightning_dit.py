...
from .model_utils import (
    VisionRotaryEmbeddingFast, SwiGLUFFN, RMSNorm, NormAttention,
...
class LightningDiTBlock(nn.Module):
    """
    Lightning DiT Block. Features include:
    - ROPE
    - QKNorm
    - RMSNorm
    - SwiGLU
    - Optional shift in AdaLN.
    """
    def __init__(
        self,
        hidden_size,
        ...
        **block_kwargs
        ...
        if use_swiglu:
            # SwiGLU from xformers is not compatible with torch.compile
